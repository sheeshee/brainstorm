    ...
    return (
        <div>
            ...
            <Routes>
                ...
                <Route path="*" element={role === "host" ? <HostApp connectionList={connectionList} connection={connection} setResults={setResults} /> : <GuestApp name={name} connection={connection} setResults={setResults}/>}/>
            </Routes>
        </div>
    )
}
